  ...
  return (
    <div className="d-flex align-items-center">
      ...
      <div className="my-3 mx-5 btn-container container">
        <button onClick={()=>setCurrentPage("for-you")} className={`mx-3 offcanvas-trigger-nav fw-bold fs-4 ${currentPage==="for-you"?"":"route-faded"}` }
        //  type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasWithBothOptions" aria-controls="offcanvasWithBothOptions"
         >For You </button>
        <button onClick={()=>setCurrentPage("top-tracks")} className={`mx-1 offcanvas-trigger-nav fw-bold fs-4 ${currentPage==="top-tracks"?"":"route-faded"}`}
        // type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasWithBothOptions" aria-controls="offcanvasWithBothOptions"
